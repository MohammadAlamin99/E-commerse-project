...
export  async function AddWishListRequest(productID) {
   try {
       ...
       let result=await axios.post(BaseUrl+'/api/v1/CreateWishList/',reqBody);
...
export async function WishListRequest(){
    try {
        let result = await axios.get(BaseUrl+'/api/v1/WishList')
        let data = result.data;
        return data;
    } catch (e) {
        unauthorized(e.response.status)
...
export async function RemoveWishListRequest(productID){
    try {
        let reqBody = {"productID":productID} 
        let result = await axios.post(BaseUrl+'/api/v1/RemoveWishList',reqBody)
        let data = result.data;
        return data;
    } catch (e) {
        unauthorized(e.response.status)
...
export async function CartlistRequest(){
    try {
        let result = await axios.get(BaseUrl+'/api/v1/CartList');
        let data = result.data['data']
        return data;
    } catch (e) {
        unauthorized(e.response.status)
...
export async function RemoveCartlistRequest(productID){
    try {
        let reqbody = {"productID":productID}
        let result = await axios.post(BaseUrl+'/api/v1/RemoveCartList', reqbody);
        let data = result.data
        return data;
    } catch (e) {
        unauthorized(e.response.status)
...
export async function CreateCartlistRequest(reqbody){
    try {
        let result = await axios.post(BaseUrl+'/api/v1/CreateCartList', reqbody);
        let data = result.data
        return data;
    } catch (e) {
        unauthorized(e.response.status)
...
export async function InvoiceCreate(){
    try {
        let result = await axios.get(BaseUrl+'/api/v1/InvoiceCreate');
        let data = result.data
...
export async function SearchByKeyword(keyword){
    try {
     let result = await axios.get(BaseUrl+"/api/v1/ListByKeyword/"+keyword);
     let data = result.data['data'];
     return data;
    } catch (e) {
     return [];
...
export async function CategoryDetailsById(categoryID){
    try {
     let result = await axios.get(BaseUrl+"/api/v1/ListByCategory/"+categoryID);
     let data = result.data['data'];
     return data;
    } catch (e) {
     return [];
...
export  async function UserVerifyRequest(email, code) {
   try {
    ...
    //    let reqbody2 = {"code": code}
       let result = await axios.post(BaseUrl+'/api/v1/UserVerify/',reqbody);
       let data = result.data;
       return data;
   }
   catch (e) {
...
export  async function CreateProfileRequiest(
    ...
    try {
     let reqbody = {cus_name:cus_name,
                    ...
                    console.log(reqbody)
        let result = await axios.post(BaseUrl+'/api/v1/CreateProfile',reqbody);
